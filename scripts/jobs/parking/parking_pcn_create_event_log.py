...
## @type: DataSource
## @args: [database = "dataplatform-stg-liberator-raw-zone", table_name = "liberator_pcn_audit", transformation_ctx = "DataSource0"]
## @return: DataSource0
## @inputs: []
DataSource0 = glueContext.create_dynamic_frame.from_catalog(database = "dataplatform-stg-liberator-raw-zone", table_name = "liberator_pcn_audit", transformation_ctx = "DataSource0")
## @type: SqlCode
...
## @type: DataSink
## @args: [connection_type = "s3", catalog_database_name = "dataplatform-stg-liberator-refined-zone", format = "glueparquet", connection_options = {"path": "s3://dataplatform-stg-refined-zone/parking/liberator/PCNFOIDetails_PCN_EVENT_LOG/", "partitionKeys": ["import_year" ,"import_month" ,"import_day" ,"import_date"], "enableUpdateCatalog":true, "updateBehavior":"UPDATE_IN_DATABASE"}, catalog_table_name = "PCNFOIDetails_PCN_EVENT_LOG", transformation_ctx = "DataSink0"]
## @return: DataSink0
## @inputs: [frame = Transform0]
DataSink0 = glueContext.getSink(path = "s3://dataplatform-stg-refined-zone/parking/liberator/PCNFOIDetails_PCN_EVENT_LOG/", connection_type = "s3", updateBehavior = "UPDATE_IN_DATABASE", partitionKeys = ["import_year","import_month","import_day","import_date"], enableUpdateCatalog = True, transformation_ctx = "DataSink0")
DataSink0.setCatalogInfo(catalogDatabase = "dataplatform-stg-liberator-refined-zone",catalogTableName = "PCNFOIDetails_PCN_EVENT_LOG")
