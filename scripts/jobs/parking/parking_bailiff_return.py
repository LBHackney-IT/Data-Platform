...
The SQL builds the Bailiff performance summary data
...
S3bucket_node3 = glueContext.getSink(
    path="s3://dataplatform-" + environment + "-refined-zone/parking/liberator/Parking_Bailiff_Return/",
    connection_type="s3",
...
S3bucket_node3.setCatalogInfo(
    ...
    catalogTableName="Parking_Bailiff_Return",
)
