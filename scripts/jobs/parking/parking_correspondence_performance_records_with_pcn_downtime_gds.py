...
AmazonS3refinedpcnfoidetails_pcn_foi_full_node1697453826330 = glueContext.create_dynamic_frame.from_catalog(
    ...
    transformation_ctx="AmazonS3refinedpcnfoidetails_pcn_foi_full_node1697453826330",
)
...
parking_raw_zoneparking_officer_downtime_node1697453968832 = glueContext.create_dynamic_frame.from_catalog(
    database="parking-raw-zone",
    push_down_predicate="to_date(import_date, 'yyyyMMdd') >= date_sub(current_date, 14)",
    table_name="parking_officer_downtime",
    transformation_ctx="parking_raw_zoneparking_officer_downtime_node1697453968832",
)

# Script generated for node parking_raw_zone - parking_correspondence_performance_teams
parking_raw_zoneparking_correspondence_performance_teams_node1697453966201 = glueContext.create_dynamic_frame.from_catalog(
    database="parking-raw-zone",
    push_down_predicate="to_date(import_date, 'yyyyMMdd') >= date_sub(current_date, 14)",
    table_name="parking_correspondence_performance_teams",
    transformation_ctx="parking_raw_zoneparking_correspondence_performance_teams_node1697453966201",
)
...
,cast(concat(liberator_pcn_ic.Response_written_by,substr(liberator_pcn_ic.response_generated_at, 1, 10) ) as string) as link_officer_total_rep_dates
,cast(concat(liberator_pcn_ic.Response_written_by,concat(substr(Cast(liberator_pcn_ic.response_generated_at as varchar(10)),1, 7), '-01') ) as string) as link_month_total

,cast(total_response_month.mth_tot_rep_monthYear_response as string) as mth_tot_rep_monthYear_response
,cast(total_response_month.mth_tot_rep_total_dates as string) as mth_tot_rep_total_dates
,cast(total_response_month.mth_tot_rep_records as string) as mth_tot_rep_records


,cast(officer_total_rep_dates.tot_rep_response_date as string) as tot_rep_response_date
,cast(officer_total_rep_dates.tot_rep_total_dates as string) as tot_rep_total_date
,cast(officer_total_rep_dates.tot_rep_records as string) as tot_rep_records
...
/*officer monthly totals*/
,'' as link_officer_total_rep_dates
,'' as link_month_total

,'' as mth_tot_rep_monthYear_response
,'' as mth_tot_rep_total_dates
,'' as mth_tot_rep_records


,'' as tot_rep_response_date
,'' as tot_rep_total_date
,'' as tot_rep_records
...
"""
SQLQuery_node1697453694651 = sparkSqlQuery(
    glueContext,
    query=SqlQuery0,
    mapping={
        "liberator_pcn_ic": S3bucketRawliberator_pcn_ic_node1,
        "pcnfoidetails_pcn_foi_full": AmazonS3refinedpcnfoidetails_pcn_foi_full_node1697453826330,
        "parking_correspondence_performance_teams": parking_raw_zoneparking_correspondence_performance_teams_node1697453966201,
        "parking_officer_downtime": parking_raw_zoneparking_officer_downtime_node1697453968832,
    },
    transformation_ctx="SQLQuery_node1697453694651",
)

# Script generated for node Liberator Refined - parking_correspondence_performance_records_with_pcn_downtime_gds
LiberatorRefinedparking_correspondence_performance_records_with_pcn_downtime_gds_node2 = glueContext.getSink(
    path="s3://dataplatform-"+environment+"-refined-zone/parking/liberator/parking_correspondence_performance_records_with_pcn_downtime_gds/",
    connection_type="s3",
    updateBehavior="UPDATE_IN_DATABASE",
    partitionKeys=["import_year", "import_month", "import_day", "import_date"],
    compression="snappy",
    enableUpdateCatalog=True,
    transformation_ctx="LiberatorRefinedparking_correspondence_performance_records_with_pcn_downtime_gds_node2",
)
LiberatorRefinedparking_correspondence_performance_records_with_pcn_downtime_gds_node2.setCatalogInfo(
    catalogDatabase="dataplatform-"+environment+"-liberator-refined-zone",
    catalogTableName="parking_correspondence_performance_records_with_pcn_downtime_gds",
)
LiberatorRefinedparking_correspondence_performance_records_with_pcn_downtime_gds_node2.setFormat(
    "glueparquet"
)
LiberatorRefinedparking_correspondence_performance_records_with_pcn_downtime_gds_node2.writeFrame(
    SQLQuery_node1697453694651
)
job.commit()
