...
--added to get pcn records rather than summary --for use in major cctv dashboards
,pcnfoidetails_pcn_foi_full.pcn
,cancellationgroup
,cancellationreason
--below is as per original summary script
...
S3bucket_node3 = glueContext.getSink(
    path="s3://dataplatform-"+environment+"-refined-zone/parking/liberator/parking_foi_pcn_gds_daily_summary_records/",
    connection_type="s3",
...
S3bucket_node3.setCatalogInfo(
    ...
    catalogTableName="parking_foi_pcn_gds_daily_summary_records",
)
