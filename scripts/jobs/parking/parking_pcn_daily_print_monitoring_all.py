...
raw_zone_liberator_pcn_tickets_node1666105465609 = glueContext.create_dynamic_frame.from_catalog(
...
16/11/2022 - added case statement for print file type
23/11/2022 - added print file type case statement prefix
18/11/2022 - to run for all events not just previous event date
20/04/2023 - converted to script and added predicate for source tables
*/
...
S3bucket_node3 = glueContext.getSink(
    path="s3://dataplatform-"+environment+"-refined-zone/parking/liberator/parking_pcn_daily_print_monitoring_all/",
    connection_type="s3",
...
S3bucket_node3.setCatalogInfo(
    ...
    catalogTableName="parking_pcn_daily_print_monitoring_all",
)
