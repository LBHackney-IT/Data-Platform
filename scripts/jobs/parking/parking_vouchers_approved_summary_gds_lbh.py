...
SQLQuery_node1720617258366 = sparkSqlQuery(
    ...
    mapping={
        ...
        "unrestricted_address_api_dbo_hackney_xref": AmazonS3unrestricted_address_api_dbo_hackney_xref_node1724077428047,
    },
...
AmazonS3parking_vouchers_approved_summary_gds_node1720617264938 = glueContext.getSink(
    ...
    + environment
    + "-refined-zone/parking/liberator/parking_vouchers_approved_summary_gds_lbh/",
    connection_type="s3",
...
AmazonS3parking_vouchers_approved_summary_gds_node1720617264938.setCatalogInfo(
    ...
    catalogTableName="parking_vouchers_approved_summary_gds_lbh",
)
