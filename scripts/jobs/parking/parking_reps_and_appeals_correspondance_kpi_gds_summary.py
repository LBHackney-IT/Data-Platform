...
Number Summary response to parking representations for GDS
...
## @type: DataSource
## @args: [database = "dataplatform-stg-liberator-raw-zone", table_name = "liberator_pcn_ic", transformation_ctx = "DataSource0"]
## @return: DataSource0
## @inputs: []
DataSource0 = glueContext.create_dynamic_frame.from_catalog(database = "dataplatform-stg-liberator-raw-zone", table_name = "liberator_pcn_ic", transformation_ctx = "DataSource0")
## @type: SqlCode
...
## @type: DataSink
## @args: [connection_type = "s3", catalog_database_name = "dataplatform-stg-liberator-refined-zone", format = "glueparquet", connection_options = {"path": "s3://dataplatform-stg-refined-zone/parking/liberator/Rep_and_Appeals_Corresp_KPI_GDS_Summary/", "partitionKeys": ["import_year" ,"import_month" ,"import_day" ,"import_date"], "enableUpdateCatalog":true, "updateBehavior":"UPDATE_IN_DATABASE"}, catalog_table_name = "parking_reps_and_appeals_correspondance_kpi_gds_summary", transformation_ctx = "DataSink0"]
## @return: DataSink0
## @inputs: [frame = Transform0]
DataSink0 = glueContext.getSink(path = "s3://dataplatform-stg-refined-zone/parking/liberator/Rep_and_Appeals_Corresp_KPI_GDS_Summary/", connection_type = "s3", updateBehavior = "UPDATE_IN_DATABASE", partitionKeys = ["import_year","import_month","import_day","import_date"], enableUpdateCatalog = True, transformation_ctx = "DataSink0")
DataSink0.setCatalogInfo(catalogDatabase = "dataplatform-stg-liberator-refined-zone",catalogTableName = "parking_reps_and_appeals_correspondance_kpi_gds_summary")
