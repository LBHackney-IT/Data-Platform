...
23/01/2024 - update because of changes made to the base google sheet
*******************************************************************************************************************/
/************************************************************
...
Hanger as (
    ...
    WHERE import_date = (Select MAX(import_date) from parking_cycle_hangars_denormalisation)),
...
Output as (
    ...
    CASE 
        ...
        When A.Wait_Total >= A.free_spaces  Then 'Yes'
        Else 'No'
    END as hangar_can_be_filled
...
AmazonS3_node1658765590649.setCatalogInfo(
    ...
    catalogTableName="parking_cycle_hangar_allocation",
)
