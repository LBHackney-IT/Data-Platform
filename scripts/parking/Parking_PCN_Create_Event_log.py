...
# Script generated for node liberator_pcn_audit
liberator_pcn_audit_node1624618979995 = glueContext.create_dynamic_frame.from_catalog(
    database="dataplatform-stg-liberator-raw-zone",
    table_name="liberator_pcn_audit",
    transformation_ctx="liberator_pcn_audit_node1624618979995",
)

# Script generated for node ApplyMapping
SqlQuery0 = """With Event_logFULL AS 
    (SELECT ticket_ref,
     CASE 
...
ApplyMapping_node2 = sparkSqlQuery(
    glueContext,
    query=SqlQuery0,
    mapping={"liberator_pcn_audit": liberator_pcn_audit_node1624618979995},
    transformation_ctx="ApplyMapping_node2",
)

# Script generated for node PCN_EventLogDeNormalisation
PCN_EventLogDeNormalisation_node3 = glueContext.getSink(
    path="s3://dataplatform-stg-refined-zone/parking/liberator/PCNFOIDetails_PCN_EVENT_LOG/",
    connection_type="s3",
    updateBehavior="UPDATE_IN_DATABASE",
    partitionKeys=["import_year", "import_month", "import_day", "import_date"],
    enableUpdateCatalog=True,
    transformation_ctx="PCN_EventLogDeNormalisation_node3",
)
PCN_EventLogDeNormalisation_node3.setCatalogInfo(
    catalogDatabase="dataplatform-stg-liberator-refined-zone",
    catalogTableName="PCNFOIDetails_PCN_EVENT_LOG",
)
PCN_EventLogDeNormalisation_node3.setFormat("glueparquet")
PCN_EventLogDeNormalisation_node3.writeFrame(ApplyMapping_node2)
job.commit()
