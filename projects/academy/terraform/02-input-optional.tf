...
variable "academy_instance_ami" {
  description = "Academy EC2 AMI ID."
  type        = string
  default     = "ami-0c6043f6e8a4652bc"
}

variable "academy_instance_number" {
  description = "Academy EC2 instance count."
  type        = string
  default     = "1"
}

variable "academy_instance_type" {
  description = "Academy EC2 size."
  type        = string
  default     = "c4.2xlarge"
}

variable "academy_user_data" {
  description = "Academy EC2 Userdata."
  type        = string
  default     = null
}
...
# General
variable "deployment" {
  description = "Deploy deployment role."
  type        = string
  default     = true
}
