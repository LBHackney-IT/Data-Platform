...
appstream_cidr = "10.131.0.0/16"

appstream_enable_nat_gateway = true

appstream_private_subnets = ["10.131.0.0/24", "10.131.1.0/24"]

appstream_public_subnets = ["10.131.2.0/24", "10.131.3.0/24"]
...
core_cidr = "10.120.22.0/24"

core_enable_nat_gateway = true

core_private_subnets = ["10.120.22.0/26", "10.120.22.64/26"]

core_public_subnets = ["10.120.22.128/26", "10.120.22.192/26"]
...
core_security_group_ingress = [
  {
    ...
    to_port     = 21064
    protocol    = "TCP"
    cidr_blocks = "10.131.0.0/24,10.131.1.0/24"
