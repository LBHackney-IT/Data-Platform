...
core_cidr = "10.129.26.0/24"

core_enable_nat_gateway = true

core_private_subnets = ["10.129.26.0/25"]

core_public_subnets  = ["10.129.26.128/25"]
...
key_name = "comino-app-prod"

whitelist = [81.140.212.189/32]
