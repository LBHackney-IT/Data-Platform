...
# Core Infrastructure - qlikview APP - qlik-image pre-built on November 26, 2020 at 4:04:15 PM UTC
variable "qlikview_app_instance_ami" {
  description = "qlikview APP Windows AMI ID."
  type        = string
  default     = "ami-0b92a6259edd602c8"
}

variable "qlikview_app_instance_number" {
  description = "qlikview APP Windows instance count."
  type        = string
  default     = "1"
}

variable "qlikview_app_instance_type" {
  description = "qlikview APP Windows size."
  type        = string
  default     = "m5.xlarge"
}
