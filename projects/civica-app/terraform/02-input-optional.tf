...
# Core Infrastructure - 20-civica
variable "civica_app_instance_ami" {
  description = "Civica APP EC2 AMI ID."
  type        = string
  default     = "ami-090eefe14ae160def"
}

variable "civica_app_instance_number" {
  description = "Civica APP EC2 instance count."
  type        = string
  default     = "1"
}

variable "civica_app_instance_type" {
  description = "Civica APP EC2 size."
  type        = string
  default     = "r5.xlarge"
}
