...
# Core Infrastructure - 20-SAM
variable "sam_instance_ami" {
  description = "SAM EC2 AMI ID."
  type        = string
  default     = "ami-0e6e8f60a5b42a4b5"

}

variable "sam_instance_number" {
  description = "SAM EC2 instance count."
  type        = string
  default     = "1"
}

variable "sam_instance_type" {
  description = "SAM EC2 size."
  type        = string
  default     = "c5.2xlarge"
}
...
# Semi-Optional variables, that should be overridden in the config/terraform/*.tfvars. Please amend as you need to fit your project!
