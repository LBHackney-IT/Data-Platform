locals {
  ...
  extra_jars     = var.jars_key == null ? "s3://${var.department.glue_scripts_bucket.bucket_id}/jars/deequ-1.0.3.jar" : join(",", ["s3://${var.department.glue_scripts_bucket.bucket_id}/${var.jars_key}", "s3://${var.department.glue_scripts_bucket.bucket_id}/jars/deequ-1.0.3.jar"])
}
