...
from glue_alarms_handler.main import lambda_handler, format_message
import os
...
class TestGlueAlarmsHandler(TestCase):
    ...
    def test_format_message_returns_correct_message(self):
        expected_message = {
            "text": "2023-01-11T13:51:06Z Glue failure detected for job: test_job_name run id: test_run_id123 Error message: An error occurred while running the job."
        }
