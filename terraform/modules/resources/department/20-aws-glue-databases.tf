...
resource "aws_ssm_parameter" "refined_zone_catalog_database" {
  tags = var.tags

  name        = "/${var.identifier_prefix}/glue_catalog_database/${local.department_identifier}/refined_zone_catalog_database"
  type        = "SecureString"
...
resource "aws_ssm_parameter" "trusted_zone_catalog_database" {
  tags = var.tags

  name        = "/${var.identifier_prefix}/glue_catalog_database/${local.department_identifier}/trusted_zone_catalog_database"
  type        = "SecureString"
