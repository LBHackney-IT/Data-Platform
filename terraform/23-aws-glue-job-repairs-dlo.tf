...
resource "aws_glue_job" "get_uprn_from_uhref" {
  ...
  default_arguments = {
    ...
    "--source_uhref_header"         = "property_reference_uh" # This will be different for different workflows
...
resource "aws_glue_job" "repairs_dlo_levenshtein_address_matching" {
  ...
  default_arguments = {
    ...
    "--source_catalog_table"        = "housing_repairs_dlo_with_cleaned_addresses_with_cleaned_addresses"
