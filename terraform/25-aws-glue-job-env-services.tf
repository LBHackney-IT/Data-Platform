module "alloy_api_ingestion_raw_env_services" {
    ...
    script_name                = "alloy-api-ingestion"
    schedule                   = "cron(0 0 23 ? * MON,TUE,WED,THU,FRI *)"
    job_parameters             = {
      "--job-bookmark-option" = "job-bookmark-enable"
      "--s3_bucket_target"    = "s3://dataplatform-stg-raw-zone"
      "--s3_prefix"           = "env-services/alloy/api-responses/"
      "--secret_name"         = "dataplatform-stg/env-services/alloy-api-key"
      ...
      "--database"            = "env-services-raw-zone"
