...
resource "aws_glue_job" "housing_elec_mech_fire_communal_lighting" {
  ...
  default_arguments = {
    "--cleaned_repairs_s3_bucket_target" = "s3://${module.refined_zone.bucket_id}/housing-repairs/repairs_electrical_mechanical_fire/housing_communal_lighting/cleaned/"
