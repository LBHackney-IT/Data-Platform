module "load_locations_vaccine_to_refined_sandbox" {
  ...
  job_parameters = {
    ...
    "--source_catalog_table"                     = "sandbox_covid_locations"
    "--source_catalog_table2"                    = "sandbox_covid_vaccinations"
  }
  crawler_details = {
    database_name      = module.department_sandbox.refined_zone_catalog_database_name
    s3_target_location = "${module.refined_zone.bucket_id}/sandbox/covid-locations-vaccinations-cleaned"
  }
}