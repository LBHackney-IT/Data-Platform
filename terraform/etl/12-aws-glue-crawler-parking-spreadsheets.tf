...
resource "aws_glue_crawler" "raw_zone_parking_manual_crawler" {
  ...
  database_name = module.department_parking_data_source.raw_zone_manual_catalog_database_name
...
resource "aws_glue_trigger" "raw_zone_parking_manual_spreadsheets_crawler" {
  tags = module.department_parking_data_source.tags
  ...
  actions {
    crawler_name = aws_glue_crawler.raw_zone_parking_manual_crawler.name
  }
}