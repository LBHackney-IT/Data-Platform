module "housing_repairs_herts_heritage" {
  ...
  source = "../modules/data-sources/housing-repairs-google-sheets-cleaning"

  department                   = module.department_housing_repairs
  short_identifier_prefix      = local.short_identifier_prefix
  identifier_prefix            = local.identifier_prefix
  data_cleaning_script_name    = "repairs_herts_heritage_cleaning"
  ...
  trusted_zone_bucket_id       = module.trusted_zone.bucket_arn
