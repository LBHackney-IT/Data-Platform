...
locals {
  ...
  redshift_schemas = merge({
    ...
    replace(aws_glue_catalog_database.private_sector_housing_raw.name, "-", "_")                         = aws_glue_catalog_database.private_sector_housing_raw.name,
  ...
  redshift_users = [
    ...
    },
    {
      ...
      schemas_to_grant_access_to = concat([
        ...
        replace(aws_glue_catalog_database.private_sector_housing_raw.name, "-", "_"),
