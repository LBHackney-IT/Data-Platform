...
module "interim_cycle_wait_list" {
  ...
  landing_zone_kms_key_arn       = module.landing_zone_data_source.kms_key_arn
  landing_zone_bucket_arn        = module.landing_zone_data_source.bucket_arn
  google_drive_document_id       = "1oFJegYEeF99nQ8vh5mF1ltQZ_Bmbhg9S"
  glue_job_name                  = "interim_cycle_wait_list"
  output_folder_name             = "g-drive"
  raw_zone_bucket_id             = module.raw_zone_data_source.bucket_id
  input_file_name                = "Interim_Cycle_Hangar_Wait_List/interim_cycle_wait_list @ 25-07-2025-A.csv"
  ingestion_schedule             = "cron(0 21 * * ? *)"
  enable_bookmarking             = true
  worksheets = {
    sheet1 : {
...
module "ops_dashboard_link" {
  ...
  landing_zone_kms_key_arn       = module.landing_zone_data_source.kms_key_arn
  landing_zone_bucket_arn        = module.landing_zone_data_source.bucket_arn
  google_drive_document_id       = "1M-f_neC71jSptfAp349ZSw-1YpCkMpLd"
  glue_job_name                  = "ops_dashboard_link"
  output_folder_name             = "g-drive"
  raw_zone_bucket_id             = module.raw_zone_data_source.bucket_id
  input_file_name                = "ops_button/ops_dashboard_link_18_07_2025.csv"
  ingestion_schedule             = "cron(0 21 * * ? *)"
  enable_bookmarking             = true
  tags                           = module.tags.values
  worksheets = {
