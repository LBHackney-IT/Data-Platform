...
module "parking_pcn_permit_nlpg_llpg_matching_via_athena_20220715" {
  count                          = local.is_live_environment ? 1 : 0
  source                         = "../modules/import-spreadsheet-file-from-g-drive"
  department                     = module.department_parking_data_source
  glue_scripts_bucket_id         = module.glue_scripts_data_source.bucket_id
  ...
  landing_zone_kms_key_arn       = module.landing_zone_data_source.kms_key_arn
  landing_zone_bucket_arn        = module.landing_zone_data_source.bucket_arn
  google_drive_document_id       = "11mDxP_U355UkpVtm71AfgdbKzMVU2XYH"
  glue_job_name                  = "PCN Permits VRM NLPG LLPG matching - 20220715"
  output_folder_name             = "g-drive"
  raw_zone_bucket_id             = module.raw_zone_data_source.bucket_id
...
module "CEO_Beat_Streets_v2" {
  ...
  worksheets = {
    sheet1 : {
      header_row_number = 0
      worksheet_name    = "CEO_Beat_Streets"
    }
  }
}
...
module "Street_CPZ_Visit_Targets_23112021" {
  ...
  worksheets = {
    sheet1 : {
      header_row_number = 0
      worksheet_name    = "CEO_Beat_Visit_Requirements"
    }
  }
}
...
module "CEO_Visit_Timings_Full" {
  ...
  worksheets = {
    sheet1 : {
      header_row_number = 0
      worksheet_name    = "CEO_Visit_Req_Timings"
    }
  }
}
...
module "FixedSchoolStreetVRMs" {
  ...
  worksheets = {
    sheet1 : {
      header_row_number = 0
      worksheet_name    = "Fixed_School_Street_VRMs"
    }
  }
}
...
module "BPLU_CLASS_PartyID_Address2" {
  ...
  worksheets = {
    sheet1 : {
      header_row_number = 0
      worksheet_name    = "Licensing_PP_Addresses"
    }
  }
}
...
module "Hackney_downs_ltn" {
  ...
  worksheets = {
    sheet1 : {
      header_row_number = 0
      worksheet_name    = "LTN_Hackney_Downs"
    }
  }
}
...
module "Ringgo_Forecast_Mins" {
  ...
  worksheets = {
    sheet1 : {
      header_row_number = 0
      worksheet_name    = "Ringgo_Mins_Forecast"
    }
  }
}
...
module "School_Streets_19012022" {
  ...
  worksheets = {
    sheet1 : {
      header_row_number = 0
      worksheet_name    = "School_Street_Camera_Locations"
    }
  }
}
...
module "school_street_extra" {
  ...
  worksheets = {
    sheet1 : {
      header_row_number = 0
      worksheet_name    = "School_Street_UPRN"
    }
  }
}
