...
resource "aws_glue_crawler" "housing_mtfh_case_notes_enriched_to_refined" {
  ...
  s3_target {
    path = "s3://${module.refined_zone_data_source.bucket_id}/housing/mtfh-case-notes-enriched/"
  }
