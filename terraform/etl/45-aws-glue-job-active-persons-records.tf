...
module "active_persons_records_refined" {
  ...
  job_parameters = {
    ...
    "--source_catalog_database_benefits"        = aws_glue_catalog_database.hben_raw_zone.name
    ...
    "--source_catalog_table_parking_permit"            = "parking_permit_denormalised_data_latest"
