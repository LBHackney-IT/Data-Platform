...
module "active_persons_records_refined" {
  ...
  job_parameters = {
    ...
    "--source_catalog_table_ctax_property"             = "ctproperty_history"
    "--source_catalog_table_ctax_account"              = "ctaccount_history"
    "--source_catalog_table_ctax_liability_person"     = "ctliab_person_history"
    "--source_catalog_table_ctax_non_liability_person" = "ctnon_liab_history"
    "--source_catalog_table_ctax_occupation"           = "ctoccupation_history"
    "--source_catalog_table_hb_member"                 = "hbmember_history"
    "--source_catalog_table_hb_ctax_assessment"        = "hbctaxass_history"
    "--source_catalog_table_hb_household"              = "hbhousehold_history"
    "--source_catalog_table_hb_rent_assessment"        = "hbrentass_history"
