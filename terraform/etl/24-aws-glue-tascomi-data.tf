...
module "tascomi_parse_tables_increments" {
  ...
  job_parameters = {
    ...
    "--deequ_metrics_location"  = "s3://${module.raw_zone.bucket_id}/quality-metrics/department=planning/dataset=tascomi/deequ-metrics.json"
  }
...
module "tascomi_applications_to_trusted" {
  ...
  job_parameters = {
    "--job-bookmark-option"     = "job-bookmark-enable"
    "--s3_bucket_target"        = "s3://${module.trusted_zone.bucket_arn}/planning/tascomi/applications"
    "--enable-glue-datacatalog" = "true"
    "--source_catalog_database" = aws_glue_catalog_database.refined_zone_tascomi.name
  ...
  crawler_details = {
    ...
    s3_target_location = "s3://${module.trusted_zone.bucket_arn}/planning/tascomi/applications"
...
module "tascomi_officers_teams_to_trusted" {
  ...
  job_parameters = {
    "--job-bookmark-option"     = "job-bookmark-enable"
    "--s3_bucket_target"        = "s3://${module.trusted_zone.bucket_arn}/planning/tascomi/officers"
    "--enable-glue-datacatalog" = "true"
    "--source_catalog_database" = aws_glue_catalog_database.refined_zone_tascomi.name
  ...
  crawler_details = {
    database_name      = aws_glue_catalog_database.trusted_zone_tascomi.name
    s3_target_location = "s3://${module.trusted_zone.bucket_arn}/planning/tascomi/officers"
  }
...
module "tascomi_locations_to_trusted" {
  ...
  job_parameters = {
    "--job-bookmark-option"         = "job-bookmark-enable"
    "--s3_bucket_target"            = "s3://${module.trusted_zone.bucket_arn}/planning/tascomi/locations"
    "--enable-glue-datacatalog"     = "true"
    "--source_catalog_database"     = aws_glue_catalog_database.refined_zone_tascomi.name
  ...
  crawler_details = {
    database_name      = aws_glue_catalog_database.trusted_zone_tascomi.name
    s3_target_location = "s3://${module.trusted_zone.bucket_arn}/planning/tascomi/locations"
  }
...
module "tascomi_subsidiary_tables_to_trusted" {
  ...
  job_parameters = {
    "--job-bookmark-option"       = "job-bookmark-enable"
    "--s3_bucket_target"          = "s3://${module.trusted_zone.bucket_arn}/planning/tascomi/"
    "--enable-glue-datacatalog"   = "true"
    "--source_catalog_database"   = aws_glue_catalog_database.refined_zone_tascomi.name
  ...
  crawler_details = {
    database_name      = aws_glue_catalog_database.trusted_zone_tascomi.name
    s3_target_location = "s3://${module.trusted_zone.bucket_arn}/planning/tascomi/"
  }
