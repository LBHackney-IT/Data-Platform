...
module "department_housing_repairs" {
  ...
  source                          = "../modules/resources/department"
...
module "department_parking" {
  ...
  notebook_instance = {
    ...
    extra_python_libs = "s3://${module.glue_scripts.bucket_id}/${data.aws_s3_bucket_object.helpers.key},s3://${module.glue_scripts.bucket_id}/${data.aws_s3_bucket_object.pydeequ.key}"
