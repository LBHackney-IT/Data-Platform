# Platform Public DNS
[![Platform Public DNS (Mgmt)](https://github.com/LBHackney-IT/infrastructure/actions/workflows/platform_public-dns.yml/badge.svg)](https://github.com/LBHackney-IT/infrastructure/actions/workflows/platform_public-dns.yml)
...
Please make all changes on a branch and raise pull request. Once merged, you can run https://github.com/LBHackney-IT/infrastructure/actions/workflows/platform_public-dns.yml to deploy.
