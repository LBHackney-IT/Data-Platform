...
resource "aws_route53_record" "spf1_hackney_gov_uk_txt" {
  ...
  type    = "TXT"
  ttl     = "3600"
  records = ["v=spf1 a ip4:63.146.199.0/24 ip4:204.14.232.0/22 ip4:195.244.16.20 ip4:81.144.190.98 ip4:83.222.226.128 ip4:212.140.253.0/24 ip4:78.153.223.178 ip4:212.21.101.140/24 ip4:205.138.36.10 include:_spf.google.com ~all"]
}
